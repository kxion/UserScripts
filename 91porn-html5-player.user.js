...
function YTPlay(){
    ...
    if( typeof(so) != 'undefined'){
        ...
        $.get('getfile.php?t=' + timestamp + '&VID=' +so.getVariable('file') +'&mp4=' + mp4 + '&seccode=' +so.getVariable('seccode') +'&max_vid='+so.getVariable('max_vid'),function(data,status){
            ...
            $('.videoplayer').html('<video id="yt-video" src="' + str + '" controls autoplay loop style="width:' + width + 'px; height:' + height + 'px"></video><p style="text-align:center"></p>');
